...
import okul.com.util.matchesWord
...
class Room(
    ...
    suspend fun checkWordAndNotifyPlayers(message: ChatMessage): Boolean {
        if (isGuessCorrect(message)){
            ...
            val score = GUESS_SCORE_DEFAULT + GUESS_SCORE_PERCENTAGE_MULTIPLAYER * timePercentageLeft
    ...
    companion object {
        ...
        const val GUESS_SCORE_PERCENTAGE_MULTIPLAYER = 50
